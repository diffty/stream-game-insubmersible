...
import { LuminosityHighPassShader } from "../libs/three/examples/jsm/shaders/LuminosityHighPassShader.js";
 ...
 * UnrealBloomPassAlpha is a version of the postprocessing unit submitted by robhawkes,
 * aimed to fix the lack of alpha handling for the original module.
 * Reference:
 * - https://github.com/mrdoob/three.js/issues/14104#issuecomment-429664412
 */
var UnrealBloomPassAlpha = function ( resolution, strength, radius, threshold ) {
    ...
    if ( LuminosityHighPassShader === undefined )
        console.error( "UnrealBloomPassAlpha relies on LuminosityHighPassShader" );
    ...
    if ( CopyShader === undefined ) {
        ...
        console.error( "UnrealBloomPassAlpha relies on CopyShader" );
...
UnrealBloomPassAlpha.prototype = Object.assign( Object.create( Pass.prototype ), {

    constructor: UnrealBloomPassAlpha,
